        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            <div className="inline-flex items-center space-x-3 bg-white/80 backdrop-blur-md border border-blue-200 rounded-full px-8 py-4 mb-8 shadow-2xl">
              ...
              <span className="text-sm font-semibold text-gray-700">Plus de 200 Véhicules Articulés</span>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {vehicles.map((vehicle) => (
              <div key={vehicle.type} className="card-3d group">
                ...
                <div className="mb-8">
                  <div className="h-48 mb-4 rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center">
                    <div className="text-center">
                      <div className="text-6xl mb-2">{vehicle.fallbackEmoji}</div>
                      <div className="text-sm text-gray-500">Image à venir</div>
                    </div>
                  </div>
                  <h3 className="text-2xl font-bold text-gray-800 mb-2 group-hover:text-gradient transition-all duration-300 text-center">
                    {vehicle.type}
                  </h3>
                  <div className="text-lg font-semibold text-blue-600 text-center">{vehicle.capacity}</div>
                </div>
